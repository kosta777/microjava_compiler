...
{	
	...
	{
		if(printStmt.getExpr().struct == Tab.intType || printStmt.getExpr().struct.getKind() == Struct.Enum || printStmt.getExpr().struct.getKind() == Struct.Bool)
		{
			Code.loadConst(5);
			Code.put(Code.print);
		}
	...
	{
		if(readStmt.getDesignator().obj.getType().equals(Tab.intType) || readStmt.getDesignator().obj.getType().getKind() == Struct.Array && readStmt.getDesignator().obj.getType().getElemType().equals(Tab.intType))
		{
			Code.put(Code.read);
		}
		else
