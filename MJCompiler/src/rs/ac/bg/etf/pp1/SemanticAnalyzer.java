...
public class SemanticAnalyzer extends VisitorAdaptor 
{
    ...
    public void visit(DesignatorIdentDot designator)
    {
    	...
    	Obj child = Tab.noObj;
    	for(Obj childObj : typeNode.getLocalSymbols())
    	{
    ...
    public void visit(StmntRead stmt)
    {
    	...
    	if(type != Tab.intType && type != Tab.charType && type.getKind() != Struct.Array)
    	{
    		errorDetected = true;
    ...
    public void visit(StmntPrint stmt)
    {
    	...
    	if(type != Tab.intType && type != Tab.charType && type.getKind() != Struct.Bool && type.getKind() != Struct.Enum)
    	{
    		errorDetected = true;
